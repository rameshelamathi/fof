 ...
 */
class F0FEncryptRandval implements F0FEncryptRandvalinterface
{
	/**
	 * @var F0FUtilsPhpfunc
	 */
	 ...
	 * Constructor.
	 *
	 * @param F0FUtilsPhpfunc $phpfunc An object to intercept PHP function calls;
	 *                         this makes testing easier.
	 *
	 */
	public function __construct(F0FUtilsPhpfunc $phpfunc = null)
	{
		if (!is_object($phpfunc) || !($phpfunc instanceof F0FUtilsPhpfunc))
		{
