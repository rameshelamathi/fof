...
interface HeaderInterface
{
	 ...
	 * Method to attach a Form object to the header.
	 *
	 * @param   SimpleXMLElement  $element  The SimpleXMLElement object representing the <header /> tag for the form
	 *                                       header object.
	 * @param   string             $group    The header name group control value. This acts as as an array container
	 *                                       for the header. For example if the header has name="foo" and the group
	 *                                       value is set to "bar" then the full header name would end up being
	 *                                       "bar[foo]".
	 *
