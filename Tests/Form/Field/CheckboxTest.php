...
class CheckboxTest extends FOFTestCase
{
    ...
    {
        $field = $this->getMock('FOF30\Form\Field\Checkbox', array('getStatic', 'getRepeatable'));
    ...
    {
        $field = $this->getMock('FOF30\Form\Field\Checkbox', array('getInput', 'getFieldContents'));
